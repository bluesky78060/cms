            ...
            <div className="border rounded-lg p-6 bg-gray-50">
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="mb-2"><strong>전화:</strong> {selectedClient.phone}</p>
                  <p className="mb-2"><strong>이메일:</strong> {selectedClient.email}</p>
